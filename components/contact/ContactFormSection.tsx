...
export default function ContactFormSection({ dict }: { dict: Dictionary }) {
  ...
  useGSAP(() => {
    // Dramatic Scale-up Entry — same pattern as Home Contact
  ...
  return (
    <section ref={containerRef} className="py-24 md:py-32 bg-[#FAFAFA] px-6 md:px-12 relative overflow-hidden">
      ...
      {/* Background Orbs — same as Home Contact */}
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        {/* Massive Contact Card — same dark glassmorphic card as Home Contact */}
        <div className="contact-card bg-gradient-to-br from-[#1e1b4b] to-[#3b0764] rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.15)] flex flex-col lg:flex-row relative border-4 border-white/50 backdrop-blur-3xl">
          ...
          {/* LEFT: Info Section — same layout as Home Contact */}
          ...
          {/* RIGHT: Form Section — same frosted white panel as Home Contact */}
